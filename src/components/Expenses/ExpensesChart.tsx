import { ChartProps, ExpensesProps } from "../../utils";
import Chart from "../Chart/Chart";

const ExpensesChart = (props: ExpensesProps): JSX.Element => {
  const chartDataPoints: ChartProps = {
    dataPoints: [
  ...
  for (let expense of props.expenses) {
    ...
    chartDataPoints.dataPoints[expenseMonth].value += expense.amount;
  }

  return <Chart {...chartDataPoints} />;
};
